...
#include "arm_nn_mat_mult_kernel_q7_q15_no_shift.hpp"
...
arm_status arm_convolve_HWC_q7_basic_nonsquare_no_shift_no_bias(const q7_t * Im_in,
...
#define ARM_MATH_DSP
    ...
    for (i_out_y = 0; i_out_y < dim_im_out_y; i_out_y++)
    {
        for (i_out_x = 0; i_out_x < dim_im_out_x; i_out_x++)
        {
            ...
            {
                pOut =
                    arm_nn_mat_mult_kernel_q7_q15_no_shift_no_bias(wt, bufferA,
                                                  ch_im_out,
                                                  ch_im_in *
                                                  dim_kernel_y * dim_kernel_x, pOut);
    ...
    if (pBuffer != bufferA)
    {
        ...
        for (i = 0; i < ch_im_out; i++)
        {
            ...
            /* Point to the begining of the im2col buffer */
            q15_t    *pB = bufferA;
